...
/* harmony import */ var _utils_menu_click__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/menu-click */ "./js/utils/menu-click.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_utils_menu_click__WEBPACK_IMPORTED_MODULE_3__["crutchMargin"])();
  Object(_utils_menu_click__WEBPACK_IMPORTED_MODULE_3__["getWidth"])(); // Modules
  // ---------------------------------

  Object(_modules_swiper__WEBPACK_IMPORTED_MODULE_2__["initSlider"])();
  Object(_modules_accordeon__WEBPACK_IMPORTED_MODULE_4__["accordeonInit"])();
  Object(_utils_menu_click__WEBPACK_IMPORTED_MODULE_3__["initMenu"])();
  Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])();
  Object(_utils_menu_click__WEBPACK_IMPORTED_MODULE_3__["toggleMenu"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана

  window.addEventListener('load', function () {
    Object(_utils_menu_click__WEBPACK_IMPORTED_MODULE_3__["onFilterButtonClick"])();
    Object(_utils_menu_click__WEBPACK_IMPORTED_MODULE_3__["closeFilterModal"])();
  });
}); // ---------------------------------
...
/*!*********************************!*\
  !*** ./js/modules/accordeon.js ***!
  \*********************************/
/*! exports provided: accordeonInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "accordeonInit", function() { return accordeonInit; });
var items = document.querySelectorAll('.acc-item');
var accordButtons = document.querySelectorAll('.acc-heading');
var content = document.querySelectorAll('.acc-content');

var accordeonToggle = function accordeonToggle(evt) {
  evt.preventDefault();
  var currentIteme = evt.target.closest('div');
  currentIteme.classList.toggle('open'); // currentIteme.classList.toggle('close');
  // const currentContent = title.nextElementSibling;
  // currentContent.classList.toggle('close');
};

var accordeonInit = function accordeonInit() {
  if (!content || !items) {
    return;
  } else {
    // items.forEach((it) => it.classList.add('close'));
    items.forEach(function (it) {
      return it.classList.remove('open');
    });
    accordButtons.forEach(function (it) {
      return it.setAttribute('tabindex', 1);
    });
    items.forEach(function (it) {
      return it.addEventListener('click', function (evt) {
        return accordeonToggle(evt);
      });
    });
  }
};
...
/*!********************************!*\
  !*** ./js/utils/menu-click.js ***!
  \********************************/
/*! exports provided: toggleMenu, crutchMargin, getWidth, initMenu, onFilterButtonClick, closeFilterModal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toggleMenu", function() { return toggleMenu; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "crutchMargin", function() { return crutchMargin; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getWidth", function() { return getWidth; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMenu", function() { return initMenu; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onFilterButtonClick", function() { return onFilterButtonClick; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "closeFilterModal", function() { return closeFilterModal; });
var menuButton = document.querySelector('.header__menu-button');
var header = document.querySelector('.header');
var wrapper = document.querySelector('.header__wrapper');
var element = document.querySelector('.products__buttons');
var neededWidth = document.querySelector('.catalog__list ');
var filterButton = document.querySelector('.filters-handler');
var filter = document.querySelector('.filters');
var closeFilterButton = document.querySelector('.filters__close');
var body = document.querySelector('body');

var onMenuClickHandler = function onMenuClickHandler() {
...
var crutchMargin = function crutchMargin() {
  var id = items.length / 2;
...
var getWidth = function getWidth() {
  if (!neededWidth || !element) {
    ...
    element.style.width = "".concat(neededWidth.offsetWidth, "px");
  }
};
...
var onFilterButtonClick = function onFilterButtonClick() {
  if (!filterButton) {
    return;
  } else {
